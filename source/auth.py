...
def getCurrentUser(token: Annotated[str, Depends(oauth2_scheme)], session : SessionDep): #does not need to be async as uvicorn will make a coroutine for it auto
